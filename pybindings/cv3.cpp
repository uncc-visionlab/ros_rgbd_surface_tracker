...
#define MODULESTR "cv_uncc"
#define NPY_NO_DEPRECATED_API NPY_1_7_API_VERSION
#include <numpy/ndarrayobject.h>

//#include "pyopencv_generated_include.h"
#include "pycv_uncc_generated_include.h"
...
#define PYOPENCV_TO  pycv_uncc_to
#define PYOPENCV_FROM  pycv_uncc_from
...
#if PY_MAJOR_VERSION >= 3
#define MKTYPE2(NAME) pycv_uncc_##NAME##_specials(); if (!to_ok(&pycv_uncc_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) pycv_uncc_##NAME##_specials(); if (!to_ok(&pycv_uncc_##NAME##_Type)) return
#endif
...
#include "pycv_uncc_generated_types.h"
#include "pycv_uncc_generated_funcs.h"
...
#include "pycv_uncc_generated_ns_reg.h"
...
#if PY_MAJOR_VERSION >= 3
extern "C" CV_EXPORTS PyObject* PyInit_cv_uncc();
static struct PyModuleDef cv_uncc_moduledef =
{
...
PyObject* PyInit_cv_uncc()
#else
extern "C" CV_EXPORTS void initcv_uncc();
...
#include "pycv_uncc_generated_type_reg.h"

#if PY_MAJOR_VERSION >= 3
  PyObject* m = PyModule_Create(&cv_uncc_moduledef);
#else
